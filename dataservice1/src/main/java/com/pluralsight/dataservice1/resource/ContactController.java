package com.pluralsight.dataservice1.resource;
...
import com.pluralsight.dataservice1.model.ContactDetails;
...
public class ContactController {
	...
	public ContactDetails getCustomerContactDetails(@PathVariable String cid) throws InterruptedException {
        ...
        return details.stream().filter(
        		detail -> cid.equals(detail.getContactId()))
        		.findAny().orElse(null);   
