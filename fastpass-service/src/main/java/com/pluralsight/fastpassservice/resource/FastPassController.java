package com.pluralsight.fastpassservice.resource;
...
import com.pluralsight.fastpassservice.model.FastPassCustomer;
...
public class FastPassController {
    ...
    public FastPassCustomer getFastPassById(@RequestParam String fastpassid) {
    	System.out.println("Fastpass retrieved for "+fastpassid);
